...
def start_attack_reply(message, target, port, time):
    ...
    keyboard.add(
        telebot.types.InlineKeyboardButton("💟JOIN CHANNEL💟", url="https://real_titan_hub")
    )
...
'''
    ...
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('💟SUPPORT❤️‍🔥', url='https://real_titan_hub'),
        telebot.types.InlineKeyboardButton('😺FEEDBACK❤️‍🩹', url='https://real_titan_hub')  
    )
...
'''
    ...
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.add(
        telebot.types.InlineKeyboardButton("CANARY 🦅", url="https://real_titan_hub")
    )
